  ...
  const steps = [
    {
      ...
      title: "Search Jobs",
      description: "Browse through hundreds of trucking positions that match your skills and preferences.",
      delay: 0,
    },
    {
    ...
    },
    {
      ...
      title: "Start Driving",
      description: "Get on the road with a job that offers competitive pay and benefits.",
      delay: 200,
    },
  ]
      ...
      <div className="container mx-auto px-4">
        <AnimateOnScroll animation="fade-up">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-blue-900 md:text-4xl">How It Works</h2>
            <p className="mx-auto max-w-2xl text-gray-600">
              Finding your next trucking job is simple with our streamlined process
            </p>
          </div>
        </AnimateOnScroll>
          ...
          {steps.map((step, index) => (
            <AnimateOnScroll key={index} animation="fade-up" delay={step.delay}>
              <div className="flex flex-col items-center rounded-lg bg-white p-8 text-center shadow-lg transition-transform hover:-translate-y-1">
                <div className="mb-6 rounded-full bg-blue-50 p-4">{step.icon}</div>
                <h3 className="mb-4 text-xl font-bold text-blue-900">{step.title}</h3>
