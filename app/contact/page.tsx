    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid gap-12 md:grid-cols-2">
        <div data-aos="fade-right">
          <h2 className="mb-6 text-2xl font-bold text-blue-900">Contact Information</h2>
          ...
          <div className="mb-8 space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">info@truckconnect.com</p>
          ...
          <div className="rounded-lg bg-blue-50 p-6">
            <h3 className="mb-4 text-lg font-medium text-blue-900">Driver Support Hotline</h3>
            <p className="mb-2 text-gray-700">For urgent driver assistance, call our dedicated support line:</p>
            <p className="text-xl font-bold text-blue-900">(555) 999-HELP</p>
            <p className="mt-2 text-sm text-gray-600">Available 24/7 for emergency assistance</p>
          </div>
        </div>
        ...
        <div data-aos="fade-left">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <Input id="email" type="email" placeholder="john.doe@example.com" required className="border-gray-300" />
            </div>
            ...
            <div>
              ...
              <Input id="phone" type="tel" placeholder="(555) 123-4567" className="border-gray-300" />
            </div>
            ...
            <div>
              ...
              <Input id="subject" placeholder="How can we help you?" required className="border-gray-300" />
            </div>
